...
*First, think about the problem. Second, read the data. Third, build the baselines. Then iterate.*
...
We'll be using Anaconda for this tutorial.
...
Once you have Conda installed, the first step is to create a Conda virtual environment.
